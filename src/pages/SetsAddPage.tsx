    ...
    return (
        <>
            <div className="h-screen flex flex-col justify-start items-center font-mono bg-blackCustom-900 bg-gradient-to-tl from-blackCustom-300 text-greenCustom">
                ...
                {!isCreating && (
                    <button onClick={() => setIsCreating(true)} className="mt-5 border-2 rounded-3xl px-3 border-greenCustom hover:scale-105 hover:text-aquamarine hover:border-aquamarine duration-300">NUEVO CONJUNTO</button>
                )}
                {isCreating && (
                    <div className="mt-5 items-center flex flex-col gap-3">
                        ...
                        />
                        <button onClick={handleCreateNewSet} className="-mb-10 hover:scale-105 hover:text-aquamarine duration-300">
                ...
                <div className="mt-16 mb-5 flex flex-col items-center w-full">
                    <h3 className="text-center mb-2 font-extrabold">Listado de Conjuntos</h3>
